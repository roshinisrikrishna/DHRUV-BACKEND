...
emailText += `
        ...
        <p style="text-align: center;">
          <a class="button" href="http://localhost:8000/men" style="background-color: #FC1258; color: #FFFFFF; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; border: 2px solid #FFFFFF; margin: 0 auto;">Shop Now</a>
        </p>
      </div>
    </div>
  </body>
