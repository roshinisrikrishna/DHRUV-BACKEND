...
emailText += `
        ...
        <p style="text-align: center;">
          <a class="button" href="${MEDUSA_STORE_URL}/men" style="background-color: #02B8F5; color: #FFFFFF; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; border: 2px solid #FFFFFF; margin: 0 auto;">Shop Now</a>
        </p>
      </div>
    </div>
  </body>
